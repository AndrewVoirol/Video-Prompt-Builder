    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full">
        ...
        <SidebarInset>
          ...
          <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center bg-[var(--surface-panel)] border-b border-[var(--border-color)] backdrop-blur-md">
            <div className="flex w-full items-center px-4">
              <SidebarTrigger className="mr-3 md:hidden" />
              <div className="flex flex-1 items-center justify-between">
                <div className="flex items-center">
                  <h1 className="text-lg font-semibold tracking-tight md:text-xl text-[var(--text-primary)]">
