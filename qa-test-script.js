...
if (typeof window !== "undefined") {
  ...
  testResults.pageNavigation.push({
    ...
    passed:
      !!mainHeading && mainHeading.textContent.includes("Video Prompt Builder"),
    element: mainHeading,
  });
  ...
  setTimeout(() => {
    ...
    Object.entries(testResults).forEach(([category, tests]) => {
      ...
      tests.forEach((test) => {
        ...
        if (test.viewport !== undefined)
          console.log(`    Viewport: ${test.viewport}px`);
